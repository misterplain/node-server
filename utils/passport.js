...
const UserModel = require("../mern-ecommerce/models/userModel.js");
const { default: axios } = require("axios");
const crypto = require("crypto");
const generateUserTokens = require("../mern-ecommerce/middleware/generateToken.js");
  ...
  new GoogleStrategy(
    {
      ...
      callbackURL: `${SERVER_URL}/mern-ecommerce/auth/google/callback`,
      profileFields: ["email"],
    },
  ...
  new GithubStrategy(
    {
      ...
      callbackURL: `${SERVER_URL}/mern-ecommerce/auth/github/callback`,
    },
